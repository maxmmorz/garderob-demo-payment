...
const mockPosts: Post[] = [
  ...
  },
  {
    ...
    avatar: "👠",
    image:
      "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=400&h=450&fit=crop",
    likes: 89,
...
const PaymentForm = ({
  ...
  useEffect(() => {
    ...
    ["wallet1", "divider", "method1", "method2", "method3"].forEach(
      (id, index) => {
        timers.push(
          setTimeout(() => {
  ...
  useEffect(() => {
    if (selectedMethod === "card") {
      ...
      [
        "newCard",
        ...savedCards.slice(0, visibleCards.length).map((c) => `card-${c.id}`),
      ].forEach((id, index) => {
        timers.push(
          setTimeout(() => {
            setAnimatedElements((prev) => ({ ...prev, [id]: true }));
  ...
  const PaymentMethodButton = ({
    ...
    onClick,
    animationId,
  }: Omit<PaymentMethodButtonProps, "method">) => {
    ...
    return (
      <button
        ...
        style={{
          ...
          transform: `scale(${
            isHovered ? 1.05 : isActive ? 1.02 : 1
          }) translateY(${isAnimated ? 0 : 20}px)`,
              ...
              {!isSelected ? (
                ...
                >
                  <input
                    ...
                    onFocus={() =>
                      setInputsFocused((prev) => ({ ...prev, card: true }))
                    }
                    onBlur={() =>
                      setInputsFocused((prev) => ({ ...prev, card: false }))
                    }
                    maxLength={19}
                    ...
                    style={{
                      ...
                      boxShadow: inputsFocused.card
                        ? "0 0 0 3px rgba(236, 103, 34, 0.1)"
                        : "none",
                  ...
                  <input
                    ...
                    onFocus={() =>
                      setInputsFocused((prev) => ({ ...prev, exp: true }))
                    }
                    onBlur={() =>
                      setInputsFocused((prev) => ({ ...prev, exp: false }))
                    }
                    maxLength={5}
                    onClick={(e) => e.stopPropagation()}
                  ...
                  <input
                    ...
                    onFocus={() =>
                      setInputsFocused((prev) => ({ ...prev, cvv: true }))
                    }
                    onBlur={() =>
                      setInputsFocused((prev) => ({ ...prev, cvv: false }))
                    }
                    maxLength={4}
                    onClick={(e) => e.stopPropagation()}
    ...
    <>
      ...
      <div className="h-full bg-white flex flex-col">
        <div className="flex-1 overflow-y-auto">
          ...
          <div
            className="p-4 bg-gradient-to-b from-gray-50 to-white"
            style={{
          ...
          >
              ...
              <button
                ...
                style={{
                  ...
                  transform: `translateY(${
                    animatedElements.wallet1 ? 0 : 20
                  }px) scale(${animatedElements.wallet1 ? 1 : 0.95})`,
                  transition: "all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                }}
              >
                <svg
            ...
            >
              ...
              <div className="relative flex justify-center">
                <span className="px-3 bg-gradient-to-b from-gray-50 to-white text-xs text-gray-400">
                  или
                </span>
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="grid grid-cols-3 gap-2">
                ...
                <PaymentMethodButton
                  ...
                  onClick={() =>
                    setSelectedMethod(selectedMethod === "kaspi" ? "" : "kaspi")
                  }
                  animationId="method2"
                />
                <PaymentMethodButton
                  ...
                  onClick={() =>
                    setSelectedMethod(selectedMethod === "halyk" ? "" : "halyk")
                  }
                  animationId="method3"
                />
              </div>
                  ...
                  {hasMoreCards && (
                    ...
                    >
                      <span>
                        {showAllCards
                          ? "Скрыть"
                          : `Показать еще ${savedCards.length - 3}`}
                      </span>
                      <ChevronDown
                        className="w-4 h-4 transition-transform duration-300"
                        style={{
                          transform: `rotate(${showAllCards ? 180 : 0}deg)`,
                        }}
                      />
                    </button>
                  )}
